  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.productsController.category_List.length > 1) {
        final categoryId = widget.productsController.category_List[1].categoryId ?? 0;
    ...
    return SizedBox(
      child: PageView.builder(
        ...
        itemBuilder: (context, index) {
          if (index < 0 || index >= widget.productsController.category_List.length) {
            return const SizedBox();
          }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        widget.isArabic
                            ? categoryModel.categoryName?.toString() ?? 'No Name'
                            : categoryModel.categoryNameEn?.toString() ?? 'No Name',
