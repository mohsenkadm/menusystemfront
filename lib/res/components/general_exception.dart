    ...
    return  Padding(
      ...
      child: Column(
        children: [
          ...
          const Icon(Icons.cloud_off , color: AppColor.redColor,size: 100,),
          Padding(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Center(child: Text('اعادة محاولة' , style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.white),)),
            ),
          )
        ],
      ),
