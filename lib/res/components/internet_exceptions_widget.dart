  ...
  Widget build(BuildContext context) {
    ...
    return  Padding(
      ...
      child: Column(
        ...
        children: [
          Lottie.asset(LottieAssets.noconnection,width: 170,fit: BoxFit.fill), 
          Padding(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Center(child: Text('اعادة المحاولة' , style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.white),)),
            ),
          )
        ],
      ),
